...
CKPT_ARGS=(
   --hf-checkpoint "$BASE_DIR"/Qwen3-14B/
   --ref-load "$BASE_DIR"/Qwen3-14B/
   --load "$BASE_DIR"/Qwen3-14B_slime/
   --save "$BASE_DIR"/Qwen3-14B_slime/
   --save-interval 10
)
...
TRAIN_BACKEND_ARGS=(
   ...
   --attn-implementation flash_attention_3 # change to 3 in hopper
